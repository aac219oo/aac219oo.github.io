    ...
    template: `
        <header>
            ...
            <nav :class="{ 'show': isMenuOpen }" class="w-full gap-2 mx-2"> 
                ...
                <ul>
                    <li @click="isMenuOpen = false"><router-link to="/">{{ $t('menu.home') }}</router-link></li>
                    <li @click="isMenuOpen = false"><router-link to="/About">{{ $t('menu.about') }}</router-link></li>
                    <li @click="isMenuOpen = false"><router-link to="/HW">{{ $t('menu.hw') }}</router-link></li>
                </ul>
            </nav>
        </header>
    `
